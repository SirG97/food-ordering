        ...
        <nav class="navbar navbar-expand-lg navbar-light custom">
            ...
            <div class="collapse navbar-collapse " id="navbarNavDropdown">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item {{\App\Classes\Menu::sidebar('/restaurants')}} px-3">
        ...
        <nav class="drop-shadow sidebar">
            <ul class="sidebar-nav d-flex justify-content-around justify-content-sm-center flex-row flex-sm-column align-items-center">
                <li class="sidebar-item">
                    <a href="/customer/account" class="profile {{\App\Classes\Menu::sidebar('/customer/account')}}">
                ...
                <li class="sidebar-item">
                    <a href="/customer/orders" class="orders {{\App\Classes\Menu::sidebar('/customer/orders')}}">
                ...
                <li class="sidebar-item">
                    <a href="/customer/notifications" class="notifications {{\App\Classes\Menu::sidebar('/customer/notifications')}}">
                ...
                <li class="sidebar-item">
                    <a href="/customer/reviews" class="reviews {{\App\Classes\Menu::sidebar('/customer/reviews')}}">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
